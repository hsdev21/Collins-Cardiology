...
const Post = ({
  ...
  const readableDate = `${newDateObject.toLocaleString("default", {
    month: "long",
  })} ${newDateObject.getUTCDate()}, ${newDateObject.getUTCFullYear()}`
  return (
    <Layout>
      ...
      <Container style={{ paddingTop: "50px" }}>
        <Row>
          ...
          <Col lg={4} className={pageStyles.sidebar}>
            ...
            <p>
              Call <a href={"tel:+1-214-739-1706"}>214-739-1706</a>
            </p>
            <p>or</p>
